...
{!! $return !!}
@endif
<h2 id="title" >{!! $db_posts['name_vn'] !!}</h2>
...
<div class="box form">
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td class="post-td">
                <textarea style="width: 400px" type="text" name="sub[vn]" >{!! $db_posts['sub_vn'] !!}</textarea>
            </td>
        </tr>
        <tr>
            <td class="post-td"><label>Subtitle Tiếng Anh: </label></td>
            <td class="post-td">
                <textarea style="width: 400px" type="text" name="sub[en]" >{!! $db_posts['sub_en'] !!}</textarea>
            </td>
        </tr>
        ...
        <div>
            ...
            <div id="text_editor_wrap">
                <div id="text_editor_vn" ><textarea type="text" name="value[vn]" >{!! $db_posts['value_vn'] !!}</textarea></div>
                <div id="text_editor_en" ><textarea type="text" name="value[en]" >{!! $db_posts['value_en'] !!}</textarea></div>
            </div>
        </div>
